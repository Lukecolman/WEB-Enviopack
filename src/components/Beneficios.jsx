...
{/* <section className='w-[100%] h-[784.17px] bg-green-500 '>
<div className='max-w-[1264px] h-[100%] mx-auto flex flex-wrap  bg-yellow-100 '>
<div className="w-[60px] h-[60px] bg-red-600 "></div>

    <div className='max-w-[1264px] mx-auto grid grid-cols-3 gap-8 justify-center items-center content-center'>
...
Beneficios
<section className='w-[1512px] h-[784.17px] bg-green-500 '>
<div className=' flex bg-yellow-100 justify-center items-center content-center'>
            ...
            <div className='w-[100%] h-[784.17px] p-[124px]  flex-col justify-start items-start gap-20 inline-flex bg-green-100'>
                <div className='flex-col justify-start items-start gap-6 flex bg-gray-500'>
                    <div className="text-white text-base font-bold font-['DM Sans'] bg-gray-300">💡 CONOCÉ</div>
