                            ...
                            <div className="integration-card-top">
                                <div className="integration-card-logo">
                                    ...
                                    <div className='integration-market-details'>
                                        ...
                                        <div className="integration-card-market-name">
                                            {card.marketName}
                                        </div>
                                    </div>
                                </div>
