    ...
    return (
        <>
            ...
            <section className='flexCenter'>
                <div className='w-[1512px] pl-[188.17px] pr-[191.83px] pt-[76.65px] pb-[160.19px] bg-gradient-to-br flex-col justify-start items-center gap-[64.37px] inline-flex bg-gray-600'>
